            ...
            <ul className="pt-4 lg:pl-12 grid gap-4.5 md:grid-cols-2 lg:grid-cols-4">
                {
                    skills.map((skill, index) => (
                        <li key={index} className="cursor-pointer transition-all scale-100 lg:hover:scale-110 bg-[#EFE5EA] p-2 rounded-4xl w-auto px-6 flex gap-2 justify-center ease-linear">
