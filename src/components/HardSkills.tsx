            ...
            <div className="pt-4.5 grid gap-8">
                <div className="pt-2">
                    ...
                    <ul className="pt-4 lg:pl-12 grid gap-4.5 md:grid-cols-2 lg:grid-cols-4">
                        <li className=" cursor-pointer transition-all scale-100 lg:hover:scale-110 bg-[#EFE5EA] p-2 rounded-4xl w-auto px-6 flex gap-2 justify-center duration-400 lg:hover:text-white shadow-lg card-fill-effect ease-linear">
                            <img className="w-6" src={html} alt="Ícone do HTML" />
                            <p className="font-bold">HTML</p>
                        </li>
                        <li className=" cursor-pointer scale-100 transition-transform lg:hover:scale-110 duration-400 lg:hover:text-white shadow-lg card-fill-effect ease-linear bg-[#EFE5EA] p-2 rounded-4xl w-auto px-6 flex gap-2 justify-center">
                            <img className="w-6" src={css} alt="Ícone do CSS" />
                            <p className="font-bold">CSS</p>
                        </li>
                        <li className=" cursor-pointer scale-100 transition-transform lg:hover:scale-110 duration-400 lg:hover:text-white shadow-lg card-fill-effect ease-linear bg-[#EFE5EA] p-2 rounded-4xl flex gap-2 justify-center">
                ...
                <div className="pt-2">
                    ...
                    <ul className="pt-6 lg:pl-12 grid md:grid-cols-2 lg:grid-cols-4 gap-4  .5">
                        <li className=" cursor-pointer scale-100 transition-transform lg:hover:scale-110 duration-400 lg:hover:text-white shadow-lg card-fill-effect bg-[#EFE5EA] p-2 rounded-4xl w-auto px-6 flex gap-2 justify-center">
                ...
                <div className="pt-2">
                    ...
                    <ul className="pt-6 lg:pl-12 grid md:grid-cols-2 lg:grid-cols-4 gap-4  .5">
                        ...
                        <li className=" cursor-pointer scale-100 transition-transform lg:hover:scale-110 duration-400 lg:hover:text-white shadow-lg card-fill-effect bg-[#EFE5EA] p-2 rounded-4xl flex gap-2 justify-center">
